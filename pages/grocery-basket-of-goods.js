...
export default function Home({ datas }) {
	...
	return (
		<div>
			...
			<p>
				The following is tracking the changes of prices in my typical grocery
				basket which I found comparable products at a regional and a national
				grocery store.
			</p>
			...
			<div>
				Everything 'feels' more expensive when going to the grocery store. I
				built out a personalized basket of goods which I track daily to see how
				prices change over time. Consistently tracking the same items allows me
				to compare the fluctuations in prices over time directly, offering
				insights into whether I'm spending more or if groceries are indeed
				rising in price.
			</div>
			<br />
